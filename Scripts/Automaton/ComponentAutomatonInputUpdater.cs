namespace CryoFall.Automaton
{
    ...
    using static AtomicTorch.CBND.CoreMod.Characters.Input.CharacterMoveModes;
    using static AtomicTorch.CBND.CoreMod.ClientComponents.Input.ClientInputManager;

    public class ComponentAutomatonInputUpdater : ClientComponent
    {
        ...
        private float GetRotationAngleRad()
        {
            ...
            if (MovementManager.OverrideRotate)
            {
                return MovementManager.GetRotationAngleRad();
            }
